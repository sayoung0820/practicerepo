...
// console.log("LEARN".length === 9 || "LEARN".length === 9)
...
// browserType = browserType.replace('moz','test');

// console.log(browserType);  // "vanilla"

// let decode = ("2h4n5o5") 
//     //  console.log(decode.replace(2, 's').replace(4, 'a').replace(5, 'n'))

//      console.log(decode.replace(/[2]/g, 's').replace(/[4]/g, 'a').replace(/[5]/g, 'n'))
