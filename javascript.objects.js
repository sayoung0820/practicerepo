...
//    let newCost = product.price * .07 + product.price
//    return newCost
...
// const moreThan = (array) => {
//     return array.filter((value) => value.age > 10) 
//     }

// console.log(moreThan(animals))

// Create a function that takes in an array of animal objects and returns a new array with a sentence about each animal.

const sentence = (array) => {
    return array.map((object) => {
        return `${object.name} is a ${object.type} and it is ${object.age} years old.`
    })
}
...
// console.log(`${object.name} is a ${object.genre} author`)
// // output: "H. G. Wells is a science fiction author"

// const authorSent = (object) => {
//     console.log(`${object.name} is a ${object.genre} author`)
// }
// console.log(authorSent(author))
